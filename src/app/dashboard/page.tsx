        ...
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="bg-white p-8 rounded-xl shadow-card border border-gray-200">
            <div className="mb-6">
              ...
              <p className="text-gray-600">Sign in with your Discord account to begin tracking your tasks.</p>
            </div>
            <LoginButton />
          </div>
        </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div className="flex items-center space-x-3">
              {isAdmin && (
                <a
                  href="/admin"
                  className="inline-flex items-center px-4 py-2 bg-purple-50 text-purple-700 rounded-lg hover:bg-purple-100 transition-colors text-sm font-medium border border-purple-200 min-h-[44px]"
                >
