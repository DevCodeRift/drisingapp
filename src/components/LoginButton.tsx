...
export default function LoginButton() {
  ...
  if (status === 'loading') {
    return (
      <div className="animate-pulse bg-destiny-dark h-10 w-32 rounded-lg"></div>
    )
  }
  ...
  return (
    <button
      ...
      className="group relative inline-flex items-center justify-center px-10 py-5 text-lg font-bold text-white transition-all duration-300 ease-out bg-gradient-to-r from-[#5865F2] to-[#4752C4] rounded-xl hover:scale-105 hover:shadow-[0_0_40px_rgba(88,101,242,0.6)] overflow-hidden"
    >
